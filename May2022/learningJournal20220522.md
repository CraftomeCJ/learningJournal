...
<h1 align="center">Learning Journal 22 May 2022 (Sunday)</h1>
...
FIND LOST or MISPLACED ITEMS:
  You know all things; 
  You know where MY CAREER Path is, and you now reveal to me where it is.
  -->
**Law of Life:** <br/>
...
**Daily Law:** <br/>
Determine the Strength of People's Character<br/>
In gauging strength or weakness, look at how people handle stressful moments and responsibility. Look at their patterns: what have they actually completed or accomplished?<br/>

<!-- What a wise old man always said -->
**Quote of the Day:** <br/>
"Today is the Day"
"You get what you deserved. Instead of being a good person today, you choose instead to become one tomorrow." - Marcus Aurelius <br/>

<!-- practice gratitude daily -->
**I'm thankful to:** have someone to make me smile through my hardest days. <br/>
...
They never overgeneralize other people through their behaviours. <br/>
They DO NOT use "you always" or "you never" to illustrate a point. Likewise, they root their arguments in the statements that begin with "I feel" as opposed to "you are." <br/>They do this because choosing language that feels unthreatening to someone is the best way to get them to open up to your perspective and actually create the dialogue that will lead to the change you desire. <br/>
...
- [x] How do I react when someone -- such as a bank teller, an auto mechanic, or a clerk-- comes to me with a lame excuse? What do I think of them and their company as a result? <br/>
- [x] When I find myself saying, "I don't know," be sure to follow it up with "--but I'll find out." It's a great way to admit what I don't know, but then take responsibility like a pro. <br/>
...
- **TOPIC**
  - [Day 25: Blog App: React Native Context with useState](https://docs.google.com/document/d/1obVGcsmgY1SHk4I15jZEN0x2vCZH6x1GlTUiUmHw-tY/edit#heading=h.e9flh4v041dw)

- **learn the how to useContext to manage global state management**
- **Udemy Learning**
- [Udemy Course Vid #123 - #134](https://www.udemy.com/course/the-complete-react-native-and-redux-course/learn/lecture/22028562#overview)

### Build a 'Blog App'

- **React Native Practice:**
- **CONCEPTS**
  - Understand why we need [useContext](https://reactjs.org/docs/context.html)?
    - Need to share data between some screens(which are siblings or grand-parent and child components).
  - What inside the context?
    - Provider, state and update-state functions
  - How to create context?
    - React's contextAPI
  - How to use context?
    - useContext API to get the state and functions
  - What need to beware?
    - Don't over use it. Only the global states in Context.

Blog App Wireframing[this](https://i.imgur.com/kuIBsxK.png):
...
- [npm install recoil](https://recoiljs.org/docs/introduction/installation)

### Development References

- [Nx](https://nx.dev/)
- [Gradle](https://docs.gradle.org/current/userguide/installation.html#installation)
- [Recoil](https://recoiljs.org/docs/introduction/core-concepts/)
- [A set of examples of using the new Recoil JS state management library](https://github.com/GeoffCox/recoil-examples)
- [Introducing Recoil: Simplified state management for React](https://blog.logrocket.com/simple-state-management-react-recoil/)
- [How can i get multiple recoil atoms when using components multiple?](https://stackoverflow.com/questions/67414428/how-can-i-get-multiple-recoil-atoms-when-using-components-multiple)
- [Build your own Recoil](https://itnext.io/build-your-own-recoil-6d3ab91eee16?gi=ad1e60e40737)
- [Recoil with React and TypeScript](https://dev.to/sirwanafifi/recoil-with-react-and-typescript-2hif)
- [An Intro to Recoil. The State Management Library for React](https://robertmarshall.dev/blog/intro-to-react-recoil-state-management-library/)
- [recoil atom effects example](https://www.jleland.com/zsw/recoil-atom-effects-example)
...
## Exercise of the Day: TypeScript **_Revisited_Day 4**
...
- **CONCEPTS**
  - Took a short break from TypeScript revision to study Anya's SHARE App setup and try to dissect it to small bits before actual action start next month.
