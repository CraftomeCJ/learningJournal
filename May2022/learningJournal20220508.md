...
<h1 align="center">Learning Journal 08 May 2022 (Sunday)</h1>
...
<!-- Week 19:
SELL MINE SKILLS or OTHER ABILITIES:
  Infinite spirit attracts to me the EMPLOYERs for my unique talents who want it and prosper in it. 
  These EMPLOYERs are being sent to me by the creative spirit of my subconscious mind, which makes no mistakes. 
  They may look at many other employees, but mine is the only one they want and will hire, because they are guided by the infinite spirit within them. 
  I know the EMPLOYER is right, the time is right, and the price is right. Everything about it is right. 
  The deeper currents of my subconscious mind are now in operation bringing us together in divine order. 
...
**I'm thankful:** to have a roof over my head.. <br/>
...
<!--note - [x] I must read, write, and plan today's pep talk, tasks & goals within 90min at 0800am in the study table today -->
...
- [x] I will code for minimum 2.5hr at 1430pm in my study table today
- [x] I will practice typing skills for 90min at 1300pm in my study table today
...
**Day 35 (Sunday) and today's main focus:** <br />
Today continue working on setup typeScript with React Native from scratch with simple "hello world" to make sure it works, and slowly build up a BentoApp and add dependencies one by one, debug error line by line if any. Try to master the workflow first. Do not rush and chase the pack. Do it at my own pace.
...
- [FAST, RELIABLE, AND SECURE DEPENDENCY MANAGEMENT](https://classic.yarnpkg.com/en/)
...
- Emulator not starting Error
![Emulator not starting error1](https://github.com/CraftomeCJ/learningJournal/blob/main/IMG/PNG/learningImgs/error4.png "style=width:200 height: 200")
![Emulator not starting error1](https://github.com/CraftomeCJ/learningJournal/blob/main/IMG/PNG/learningImgs/error5.png "style=width:200 height: 200")
- possible Solution 1
- [Setting up the development environment](https://reactnative.dev/docs/environment-setup)
- possible Solution 2
- [Watchman Installation](https://facebook.github.io/watchman/docs/install.html)
- **Best solution**:
- [How To Fix – Error “SDK location not found” in Android, React Native or Flutter ?](https://gankrin.org/how-to-fix-error-sdk-location-not-found-android-react-native-flutter/)

```bash
# steps taken to resolve emulator starting issue
#  re-install all the dependencies and made sure the project is using correct native packages?
# @filename:  ~/Desktop/COMPANY-WORK-SPACE/myLearnerFolder/BentoApp
rm -r node_modules
npm install
...
- Yarn Dependencies Error
- ![Emulator not starting error1](https://github.com/CraftomeCJ/learningJournal/blob/main/IMG/PNG/learningImgs/error6.png "style=width:200 height: 200")
- Solution resources:
- [A guide to understanding how Yarn hoists dependencies and handles conflicting packages](https://maier.tech/posts/a-guide-to-understanding-how-yarn-hoists-dependencies-and-handles-conflicting-packages)
- [Types of dependencies](https://classic.yarnpkg.com/lang/en/docs/dependency-types/)
- [Installing dependencies](https://classic.yarnpkg.com/lang/en/docs/installing-dependencies/)
- [Managing dependencies](https://classic.yarnpkg.com/lang/en/docs/managing-dependencies/)
...
- Read 1 chapter / 30min to read Computational Thinking.
