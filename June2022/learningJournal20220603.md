...
<h1 align="center">Learning Journal 03 June 2022 (Friday)</h1>
...
The month of June will teach me how to make people bend to my will without their realizing what I have done. And if they do not realize what I have done, they will neither resent nor resist me. -->
Take Control of My Image<br/>
Never let people think they have me completely figure out. Create some mystery around me.<br/>

<!-- What a wise old man always said -->
**Quote of the Day:** <br/>
"It is good to have an end to journey toward; but it is the journey that matters, in the end" - Ernest Hemingway <br/>

<!-- practice gratitude daily -->
**I'm thankful for:** Medicine. I am so lucky in this time that many ailments can be healed by the medicine we have. <br/>
...
Discomfort is what happens when I am on the precipice of change. <br/> I often confuse it for unhappiness and cope with the latter while running from the former. <br/>
It usually takes a bit of discomfort to break through to a new understanding, to release a limiting belief, to motivate myself to create real change. <br/> Discomfort is a signal, one that is often very helpful. <br/>
...
- [x] Ask myself: What did I want to be as I aged? <br/>
- [x] How would I define a great relationship? Do I've it right now? <br/>
...
**Day 61 (Friday) and today's main focus:** <br />
...
- **Step 15: navigate to main flow**
  - [Navigation outside of React Logic](https://i.imgur.com/TfUC2mZ.png)
  - what navigationRef.js do?
    - a clever function to get access to navigator
    - navigate function for everyone else to use

```bash
# 15.1 create a helper file
# @filename: projectFolder/tracker/src
touch navigationRef.tsx
```

```typescript
// @filename: projectFolder/tracker/src/navigationRef.tsx
// 15.6 import CommonActions from 'react-navigation' to use the navigate function
import { CommonActions } from '@react-navigation/native';

// 15.2 define a variable called navigator
let navigator;

// 15.3 now setup our clever function
...
// 15.4 import the helper file
// need use curly braces because I am not importing default module
...
- **JARGON in laymen terms:**
  - [Forwarding Refs](https://www.geeksforgeeks.org/reactjs-forwarding-refs/)
    - [Ref forwarding](https://reactjs.org/docs/forwarding-refs.html) is a technique for automatically passing a ref through a component to one of its children
  ...
  - [Refs and Forward Refs in React](https://medium.com/swlh/refs-and-forward-refs-in-react-be5bcb86fc69)
