...
<h1 align="center">Learning Journal 30 April 2022 (Saturday)</h1>
...
Appearing better than others is always dangerous, <br/>
but most dangerous of all is to appear to have no faults or weaknesses. <br/>
Envy creates silent enemies, <br/>
Defuse it by occasionally downplaying virtues. <br/>

<!-- What a wise old man said -->
**Quote of the Day:** <br/>
"A second line of research has shown that economic stress robs us of cognitive bandwidth. <br/>
Worrying about bills, food or other problems, leaves less capacity to think ahead or to exert self-discipline. <br/>
So, poverty imposes a mental tax." - Nicholas Kristof

<!-- practice gratitude daily -->
**I'm grateful to:** God everyday that my eyes flutter open and I can jump out of that bed excitingly!

<!-- what is holding me back all these years -->
**How to Approach my Life like the Greats:** <br/>
The Psychology of DAILY ROUTINE: <br/>
Routine is important because habitualness creates mood, and mood creates the "nurture" aspect of my personality, not to mention that letting myself be jerked around by impulsiveness, is a breeding ground for everything I essentially do not want. <br/>
<br/>
My habit create my mood, and my mood is a filter through which I experience my life. <br/>
It would make sense to assume that moods are created from thoughts or stressors, things that crop up during the day and knock us off killer. <br/>
This isn't so. Moods are created by our habitualness: <br/>
how much we sleep, how frequently we move, what we think, how often we think it, and so on. <br/>
The point is that it's not one thought that throws us into a tizzy: <br/>
It's the pattern of continually experiencing that thought that compounds its effect and makes it seem valid. <br/>
...
- [x] Think of someone who cares deeply for me. What would they say my Purpose is? <br/>
- [x] What am I avoiding doing because it's hard or scary? <br/>
...
<!-- Family => 1 task -->
<!--note [x] I will kiss my wife at START & at END of the day at home today -->
...
**Day 27 (Saturday) and today's main focus:** <br />
Today will be working on App's SplashScreen Carousel by utilising React, Hooks, TypeScript and Styled Components.
...
- I need the content for our slides. 
  - First, I created a Carousel component which will contain several children.
  - The individual slide components that will be passed as JSX elements.

```TypeScript
import * as React from 'react';
import styled from 'styled-components';

//This component will contain several children
//individual slide components will be passed to JSX elements

const SCarouseWrapper = styled.div`
	display: flex;
`;
...
const CarouselComponent = ({ children }: IProps) => {
	...
	return (
		<div>
			<SCarouseWrapper>{activeSlide}</SCarouseWrapper>
		</div>
	);
};
...
<SContainer>
  ...
  <img src="assets/recipeMenu/ella-olsson-yb6bm_66Jdk-unsplash.jpg" />
</SContainer>
}
...
```
  ...
  - import the CarouselComponent.tsx to AppCarousel.tsx and pass through those child components. 
  - The reason we decided to design the Carousel this way was so that if we ever needed to use it elsewhere (which eventually we did) we could just call our Carousel component again and pass in different slides as children.
- 
**Principles: - import * as React from 'react'; vs import React from 'react';**

- What is the difference between import * as react from 'react' vs import react from 'react'
  - Pattern import * as React from 'react is related to the use of type systems in React like Flow or Typescript. 
  - Using import React from 'react' has led to issues with importing types definitions. 
  - For now in Typescript you can use allowSyntheticDefaultImports flag, which resolves this issue and imports all types even if you use import React from 'react'.
<br/>
...
- Day 28 is continue to learn and practice.
