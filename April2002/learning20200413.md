...
![Error Msg](https://github.com/CraftomeCJ/learningJournal/blob/main/image/Screenshot%202022-04-13%20at%2011.22.16%20AM.png)

1. Expo-cli is installed but "-bash: expo: command not found" error message

2. "command not found: jest" error message

3. "No overload matches this call with styled components TypeScript" error message when I write a nested function components with View & StyleSheet
