...
<details>
  ...
  <ul>
    ...
    <li><a href="#what-other-difficulties-i-had-tried-to-resolve">Other difficulties</a></li>
...
3. Play around buttons, touchableOpacity, onPress props
...
1. took a nice nap to recharge before giving another big push
...
- Stack Navigator
  ...
  - finalize my learningJournal.md layout to give it more content
  - practice how to create a React Component
  - read on Navigating Between Screens
...
- Day 12 is continue to learn and practice on Day 8 & 9 notes of React Native concepts and at the same time practice on TypeScript projects.

- After completed day 8 & 9 React Native's notes, required to go back to build Udemy's Project with TypeScript

- Seek time management improvements

- Practice React Native mini project
...
- Every single marvelous talented course mates of JFSD Cohort 4 learning together in this 6 months journey:
  - Willy, Janson, Jan, Christmin and Alvin <br />
...
[Delete Git remote branch](https://www.git-tower.com/learn/git/faq/delete-remote-branch/)
