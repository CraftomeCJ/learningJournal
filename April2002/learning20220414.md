...
## What other difficulties I had tried to resolve? <br />
...
1. Try to delete branches in Git remote?
  After asking Mr Google, I found a solutions:
...
- Day 11 is continue to learn and practice on Day 8 notes of React Native concepts and at the same time practice on TypeScript projects.

- After completed day 8 & 9 React Native's notes, required to go back to build Udemy's Drag & Drop Project with TypeScript

- Learn to generate React Application that uses TypeScript [not done on day 10]

- Build React Components with TypeScript Interfaces for scalable features [not done on day 10]
