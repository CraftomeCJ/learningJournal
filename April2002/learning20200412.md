...
- Learn to generate React Application that uses TypeScript [done on day 9]

- Build React Components with TypeScript Interfaces for scalable features [done on day 9]
